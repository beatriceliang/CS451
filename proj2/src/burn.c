...
void init(void) {
    ...
    float coord1[6] = { 0.1, 0.1, -0.5, 0.6, -0.3, 0.3 };
    float coord2[6] = { -0.5, 0.025, 0.15, 0.15, -0.1, 0.1 };
    float speed[3] = {0.00003, 0, 0.0};//{0.2,0.0,0.3};
...
int main(int argc, char **argv) {
    ...
    glutCreateWindow("Burning Planes");
    init();
